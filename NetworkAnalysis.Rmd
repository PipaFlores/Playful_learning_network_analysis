...
Data <- Data %>%
  dplyr::select(grade, `engage1`,`engage2`,`engage3`,`SUM FLOW`, `SUM intric`, `SUM identifie`, `SUM exter`, `SUM amoti`, `SUM perimp`) %>%
  rename(
    flow = `SUM FLOW`,
...
save(Network, Network_array, Network_array2, Network_array3,CentralStability, CentralStability_array, CentralStability_array2, CentralStability_array3,
...
```{r}
names <- c("Interest", "Skill", "Challenge", "Flow", "Intrinsic\nmotivation", "Identified\nregulation", "External\nregulation", "Amotivation", "Perceived\nimportance")
